...
\ExplSyntaxOn
	...
	\str_set_eq:NN \l_colorHueSelection_str \l_blueColorHue_str
	...
	\str_case_e:nn {\l_colorHueSelection_str}
	{
		{\l_greyColorHue_str} {
			...
			\colorlet{tagline}{black!90} % Used for : \tagline
			\colorlet{heading}{black!90} % Used for : \cvsection
			\colorlet{headingrule}{black} % Used for : \rule
			\colorlet{subheading}{black!85} % Used for : \cvsubsection, \cvsubsubsection
			\colorlet{accent}{black!95} % Used for : \cvref(#1), \cvskill(#1), \skillfive, \cvachievment(#1), \cvevent(#1), \quote, \printinfo(#1)
