...
\cvevent{Diplôme universitaire - Formation Adaptée Enseignement (FAE) 1^{er} degré}{Institut National Supérieur du Professorat et de l'Education}{2019 - 2020}{Lyon}
\begin{itemize}
...
\cvevent{Missions ponctuelles d'intérim}{Agence d'intérim}{2014 ~ 2018}{Lyon}
\begin{itemize}
...
\cvsubsection{Langages de modélisation et simulation}
\cvtag{Modelica}
\cvtag{Simulink}$
...
\cvsubsection{Systèmes d'exploitation}
\cvtag{Windows}
\cvtag{GNU/Linux}

%% OUTILS BUREAUTIQUES
\cvsubsection{Outils bureautiques}
\begin{itemize}
	\item Suites office : 
...
\begin{tabularx}{\linewidth}{@{}X >{\raggedright\arraybackslash}X@{}}
	...
	\hline
	\emphasis{Anglais} & \skillfive{5}\par%
	\begin{itemize}
			\item Niveau CERCL B2-C1
			\item TOEIC 820pts (2014)
	\end{itemize}
	\hline
	\emphasis{Anglais}
	& \skillfive{4}
