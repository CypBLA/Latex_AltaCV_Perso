...
\begin{itemize}
\item En charge les lundi et mardi d'une classe de CP à l'école élémentaire "Les Chadrillons" de Soucieux-en-Jarrest.
\item En formation en parallèle à mi-temps à l'Institut National Supérieur du Professorat et de l'Education de Lyon. 
\end{itemize}

\divider

\cvevent{Adjoint territorial d'animation}{Mairie de Meyzieu}{Juillet 2019 - 3 semaines}{Meyzieu}
\begin{itemize}
