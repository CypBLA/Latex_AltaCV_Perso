...
%		\smallskip
	...
	% Command used when declaring the locations in \cvevent
	\renewcommand{\placeFont}[1]{
	...
	% Separator to place between elements as desired
	\renewcommand{\divider}{
		\vspace{-1.4ex}{\color{body!30}{\hdashrule{\linewidth}{0.6pt}{0.5ex}}}
		\smallskip
	}
