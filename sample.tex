...
\ExplSyntaxOn
	...
	\dim_set:Nn \c_titlesIndentRef_dim {1.2cm}
	
	%% Command \cvsubsection
	% > \cvsubsection{heading}
	\renewcommand{\cvsubsection}[1]{
		\titleSkip
		\hspace{1em}\color{subheading}{\uline{\large{\titlesfont{#1}}}}\par
		\titleSkip
	}
	...
	\renewcommand{\cvsubsubsection}[1]{
		\titleSkip
		\hspace{2em}\color{subsubheading}{\uline{\normalsize{\titlesfont{#1}}}}\par
		\titleSkip
	}
	...
	\str_set_eq:NN \l_colorHueSelection_str \l_goldenAndRed_str
