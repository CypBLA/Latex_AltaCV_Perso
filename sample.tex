...
\renewcommand{\titlesfont}{\merriweathersans\textbf}
...
\renewcommand{\namefont}{\Huge\titlesfont}
\renewcommand{\personalinfofont}{\footnotesize\merriweathersans}
\renewcommand{\cvsectionfont}{\LARGE\underline\titlesfont}
\renewcommand{\cvsubsectionfont}{\large\underline\titlesfont}
\renewcommand{\cvsubsubsectionfont}{\normalsize\underline\titlesfont}
...
\colorlet{subheading}{DimGray} % Used for : \cvsubsection, \cvsubsubsection
\colorlet{accent}{DeepSkyBlue} % Used for : \cvref(#2), \cvskill(#2), \skillfive, \cvachievment(#1), \cvevent(#2), \quote, \printinfo(#1)
\colorlet{emphasis}{CornflowerBlue} % Used for : \cvref(#1), \cvskill(#1) \cvachievment(#2), \cvevent(#1)
...
\cvevent{Missions ponctuelles d'intérim}{Agences d'intérim}{2014 \til~ 2018}{Lyon}
\begin{itemize}
