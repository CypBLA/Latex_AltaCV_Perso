...
\ExplSyntaxOn
	...
	\str_set:Nn \l_colorHueSelection_str {greyHue}
	...
	% Options selection
	\str_set:Nn \l_greyColorHue_str{greyHue}
	\str_set:Nn \l_blueColorHue_str{blueHue}
	
	%% Color fields definition
	\str_case:nn {\l_colorSelect_str}
	{
		{\l_greyColorHue_str} {
...
\ExplSyntaxOn
Selected coloration : \str_use:N \l_effectiveColorHue_str
\ExplSyntaxOff
