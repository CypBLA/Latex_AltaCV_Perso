...
\PassOptionsToPackage{final,unicode}{hyperref} 
...
%%%% Option pour désactiver les messages de warning désirés
% Package silence – Selective filtering of error messages and warnings
...
%%%% 
	...
	\newcommand{\textbulletWithSpace}{
		{\textbullet \hspace{1ex}}
	}
...
%	\renewcommand{\tabcolsep}{3pt}
	...
	% Available options
	\str_const:Nn \c_greyColorHue_str {greyHue}
	\str_const:Nn \c_blueColorHue_str {blueHue}
	\str_const:Nn \c_goldenAndRed_str {goldenAndRed}
	
	% To modify to choose the switch-case option
	\str_set_eq:NN \l_colorHueSelection_str \c_greyColorHue_str
	...
	\str_case_e:nn {\l_colorHueSelection_str}
	{
		{\c_greyColorHue_str} {
			...
			\colorlet{subheading}{black!75} % Used for : \cvsubsection,
			\colorlet{subsubheading}{black!65} % Used for : \cvsubsubsection
...
%			\str_set_eq:NN \l_effectiveColorHue_str \c_greyColorHue_str
		}
		...
		{\c_blueColorHue_str} {
			...
			\colorlet{headingrule}{black} % Used for : \rule
			\colorlet{subheading}{Navy} % Used for : \cvsubsection
			\colorlet{subsubheading}{Navy} % Used for : \cvsubsubsection
...
%			\str_set_eq:NN \l_effectiveColorHue_str \c_blueColorHue_str
		}
...
%	\addbibresource{sample.bib}
	...
	\str_const:Nn \c_authorName_str {Cyprien~BLANC}
...
\tagline{Jeune diplômé ingénieur, spécialisé en automobile et transports - Dominante orientée informatique, énergétique et électronique}
...
\personalinfo{%
	...
	\printinfo{\faBaby}{24/05/1995, 25 ans} % Birthday and age
	\printinfo{\faPhone}{(+33)6 98 13 97 81} % Phone number
	\printinfo{\faAt}{cyprien.blanc@zaclys.net}[mailto:cyprien.blanc@zaclys.net] % Mail
	\printinfo{\faEnvelope}{19 allée George Sand 69330 Jonage} % Mail adress
	\printinfo{\faCar}{Permis A et B -- véhicule personnel} % Driving license
	\printinfo{\faLinkedin}{cyprienblanc}[https://linkedin.com/in/cyprienblanc] % LinkedIn account
	\printinfo{\faGithub}{CypBLA}[https://github.com/CypBLA] % Github account
%	\printinfo{\faGlobe}{}[] % Personal website
%	\printinfo{\faTwitter{}[] % Twitter account
%	\printinfo{\faGitlab}{}[] % Gitlab account
%	\printinfo{\aiOrcid}{}[] % Open Researcher and Contributor ID : https://fr.wikipedia.org/wiki/ORCID
%	\printinfo{\faMapMarker}{}[]
}

\makecvheader

%% To contro which coloration as been selected.
%\ExplSyntaxOn
%	Selected~coloration~: \\
...
%		\DrawEnumitemLabel
	...
	\cvevent{Professeur des écoles stagiaire}{Education nationale}{2019 -- 2020}{Soucieu-en-Jarrest, Rhône}
	\begin{itemize}
	...
	\begin{itemize}
		\item Intégré au sein de l'équipe système autour du produit \emph{Electric SuperCharger}, un compresseur de suralimentation électrique
...
%	\end{itemize}
	...
	\cveventCalendarBox{2015 {\textasciitilde{}} 2017}
	\cveventMapBox{Nevers, Nièvre}\par
	...
	\cveventCalendarBox{2015 {\textasciitilde{}} 2018}
	\cveventMapBox{Nevers, Nièvre}\par
...
%			}
%		} \\
		\multicolumn{2}{l}{\shortstack[l]{\textbulletWithSpace Niveau CERCL B2-C1 \\ %
				\textbulletWithSpace TOEIC 820pts (\faCalendar~2014) \\ %
				\textbulletWithSpace Lecture et visionnage régulier de média en en langue anglais.}} \\
		\hline
		\emphasis{Italien}\par & \skillfive{2}\par \\
%		\multicolumn{2}{l}{
%			\textbullet Niveau CERCL B1
%		} \\
		\multicolumn{2}{l}{\textbulletWithSpace Niveau CERCL B1} \\
	\end{tabular}
	...
	\cveventPlacePar{\faAngleDoubleUp \hspace{0.5ex} Escalade en club}
	\begin{quote}
	...
	\cveventPlacePar{\faBiking \hspace{0.5ex} Vélo}
	\begin{quote}
	...
	\end{quote}
%	\begin{itemize}[labelwidth=1.5em, leftmargin=!]
